        ...
        >
            ...
            >
                ...
                <div className="p-4 bg-orange-50 rounded-lg border-2 border-orange-200 mb-4">
                    ...
                    <h3 className="font-bold text-orange-900">Total Price: ₹{totalAmount}</h3>
                </div>
                ...
                <div className="mb-4 flex justify-between items-center">
                    <button
                        ...
                        className={`w-1/2 py-2 rounded-l-lg font-semibold border border-orange-400 ${paymentMethod === "qr"
                    ...
                    <button
                        ...
                        className={`w-1/2 py-2 rounded-r-lg font-semibold border border-orange-400 ${paymentMethod === "card"
                                ? "bg-orange-500 text-white"
                                : "bg-white text-orange-700"
                            }`}
                    >
                ...
                {paymentMethod === "card" && (
                    <div className="space-y-4">
                        <div className="flex flex-col gap-1">
                            <label className="font-semibold text-orange-900">Card Number</label>
                            <input
                                type="text"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1">
                                <label className="font-semibold text-orange-900">Expiry Date</label>
                                <input
                                    type="text"
                                    placeholder="MM/YY"
                                    className="p-2 border-2 border-orange-200 rounded-lg focus:border-orange-500"
